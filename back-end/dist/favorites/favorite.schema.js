...
let Favorite = class Favorite extends mongoose_2.Document {
    user;
    item;
};
...
__decorate([
    (0, mongoose_1.Prop)({ type: mongoose_2.Types.ObjectId, ref: 'Item', required: true }),
    __metadata("design:type", Object)
...
exports.FavoriteSchema.index({ user: 1, item: 1 }, { unique: true });
