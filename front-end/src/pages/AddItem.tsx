    ...
    return (
        <div className="max-w-5xl mx-auto pb-12">
            <div className="flex items-center mb-6">
                ...
                <div>
                    <h2 className="text-3xl font-bold text-gray-900 tracking-tight">Add New Item</h2>
                    <p className="text-gray-500 mt-1">Fill in the details below to add an item to your wardrobe.</p>
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-7 space-y-6">
                        <div className="bg-surface p-6 rounded-2xl shadow-soft border border-gray-100">
                            <h3 className="text-lg font-semibold text-gray-900 mb-5 pb-3 border-b border-gray-100">Item Information</h3>
                    ...
                    <div className="lg:col-span-5 space-y-6">
                        <div className="bg-surface p-6 rounded-2xl shadow-soft border border-gray-100">
                            <h3 className="text-lg font-semibold text-gray-900 mb-5 pb-3 border-b border-gray-100">Item Location</h3>

                            <div className="space-y-5">
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Location (Level 1)</label>
                                    <select
                                        required
                                        value={locL1} onChange={e => setLocL1(e.target.value)}
                                        className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all bg-white"
                                    >
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Cabinet (Level 2)</label>
                                    <select
                                        value={locL2} onChange={e => setLocL2(e.target.value)}
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Shelf (Level 3)</label>
                                    <select
                                        value={locL3} onChange={e => setLocL3(e.target.value)}
                                        className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all bg-white disabled:bg-gray-50"
                                        disabled={!locL2}
                                    >
                                ...
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-1">Box (Level 4)</label>
                                    <select
                                        value={locL4} onChange={e => setLocL4(e.target.value)}
                                        className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-primary-500 focus:border-transparent transition-all bg-white disabled:bg-gray-50"
                                        disabled={!locL3}
                                    >
                                        <option value="">Select Box</option>
                                        <option value="Box Alpha">Box Alpha</option>
                                        <option value="Box Beta">Box Beta</option>
                                    </select>
                                </div>
                            </div>
                        </div>
